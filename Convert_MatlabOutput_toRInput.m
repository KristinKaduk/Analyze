        ...
        for r = runs';
            ...
            if Task_type(1) == 10  ||Task_type(1) == 9
                ...
                for indTrial = 1: nTrials(end)
                    FreqMot_FixAcq_to_TarHol(indTrial) = NaN; FreqMot_TarHol_to_Sound(indTrial) = NaN;  M2S_ResponseTime(indTrial)  = NaN;  FreqMot_Sound_to_RewardDelivery(indTrial) = NaN;FreqMot_ITI(indTrial)  = NaN;
                    ...
                    elseif data(indTrial).completed == 1 && data(indTrial).success == 1
                        M2S_ResponseTime(indTrial)     =[data(indTrial).states_onset(data(indTrial).states == 5) - data(indTrial).states_onset(data(indTrial).states == 4)];
                        % no touch signal
                        %data(indTrial).tSample_from_time_start
                        %data(indTrial).x_hnd'
                ...
                switch  Task_type(1)
                    case 10
                        ...
                        Tab_Trial = array2table([nTrials; completed; success ; target_selected_Hand; target_selected_Eye; target2_selected_Hand;...
                            ...
                            Freq_RewardDelivery'; FreqMot_ITI';HistMot_ITI';M2S_ResponseTime'; Wagering_ResponseTime]');
                        ...
                        Tab_Trial.Properties.VariableNames = {getname(nTrials),getname(completed),getname(success),getname(target_selected_Hand),...
                            ...
                            getname(Freq_RewardDelivery),getname(FreqMot_ITI),getname(HistMot_ITI),getname(M2S_ResponseTime),getname(Wagering_ResponseTime)};
                    ...
                    case 9
                        ...
                        Tab_Trial = array2table([nTrials; completed; success ; target_selected_Hand; target_selected_Eye; PosTar_ChoosenOption; aborted_state; Task_type;Rotation_Sample; Rotation_t1; Rotation_t2; Rot_Diff;...
                            ...
                            Freq_RewardDelivery'; FreqMot_ITI';HistMot_ITI';M2S_ResponseTime']');
                        % give the colums a name
                        Tab_Trial.Properties.VariableNames = {getname(nTrials),getname(completed),getname(success),getname(target_selected_Hand),getname(target_selected_Eye),...
                            ...
                            getname(FreqMot_TarHol_to_Sound), getname(HistMot_TarHol_to_Sound),getname(FreqMot_Sound_to_RewardDelivery),getname(Freq_RewardDelivery),getname(FreqMot_ITI),getname(HistMot_ITI),getname(M2S_ResponseTime)};
                end
